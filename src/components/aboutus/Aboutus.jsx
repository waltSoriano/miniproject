    ...
    <div className='about-container' id="boxes">
      ...
      <div className="right-part" id="boxes">
        <p className="second-paragraph"> At EcoTour Philippines, we believe in the importance of preserving the pristine natural wonders of the Philippines for future generations. We offer detailed guides on eco-friendly destinations, sustainable activities, and local communities that embrace environmentally conscious practices. From breathtaking beaches to lush forests, our website showcases a diverse range of destinations that will leave you awe-inspired.
          ...
          <br />
          Join us on this incredible journey of exploration, discovery, and sustainability. Let's embark on unforgettable adventures while being mindful of our planet. Start planning your eco-friendly trip with EcoTour Philippines today!</p>
      </div>
    </div>
  )
}
